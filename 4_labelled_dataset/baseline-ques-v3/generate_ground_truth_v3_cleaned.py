...
class Insight(BaseModel):
    ...
    comprehensive_answer: str = Field(
        description="The insight as a complete answer (3-5 sentences revealing deep understanding, patterns, or principles)"
    )
...
def main():
    ...
    print("\n✅ Insights generation complete! (v3 cleaned - insights only)")
    print(f"📈 Summary:")
