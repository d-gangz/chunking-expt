"""
Streamlit app for visualizing ground truth questions and dimensions data from v3 dataset.

Run with: uv run streamlit run visualizer.py
...
# Page configuration
st.set_page_config(
    page_title="Ground Truth Data Visualizer - V3",
    page_icon="🔍",
    layout="wide",
...
def main():
    ...
    # App title
    st.title("🔍 Ground Truth Data Visualizer - V3")
    st.markdown("---")
